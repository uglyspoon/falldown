<template>
  <div class="page-charge-group-time" id="page-charge-group-time" ref="pageChargeGroupTime">
      ...
      renderContent () {
        ...
        areaGroups
          ...
          .html((d) => {
            ...
            let row = 0
            let nameLength = parseInt(areaScale(d.number) / 10)
