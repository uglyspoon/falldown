<template>
  <div class="page-penalty" id="page-penalty" ref="pagePenalty">
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      prepareData () {
        ...
        this.chartData.maxHeight = width * 0.01
