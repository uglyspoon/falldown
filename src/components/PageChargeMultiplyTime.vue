<template>
  <div class="page-charge-multiply-time" id="page-charge-multiply-time" ref="pageChargeMultiplyTime">
      <div class="assay" v-if="!init">
        截至2017年10月14日，据中央纪委监察部网站，共有103名中管干部公布判决罪名，受贿为最常见罪行。据财新此前统计，中共十八大后贪腐金额过亿元的高官共16人，其中天津市政协原副主席武长顺涉案金额最大，逾5亿元。
      </div>
  </div>
</template>
  ...
  export default {
    ...
    data () {
      return {
        ...
        init: false,
        chartData: {
          areaPos: [[556, 426], [550, 160], [42, 114], [462, 584], [42, 658], [336, 76], [54, 556], [448, 336], [584, 376], [222, 656], [160, 708], [260, 614], [522, 240], [536, 496], [266, 526], [372, 684], [92, 160]],
          rankOrder: RANKORDER,
          rankColor: RANKCOLOR,
...
<style scoped>
  ...
  .example-details-assay p.info-name {
    font-weight: 300;
    margin-bottom: 0.5em;
  }
</style>
